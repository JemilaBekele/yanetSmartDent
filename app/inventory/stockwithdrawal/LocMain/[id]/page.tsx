...
import UpdateStockLocationMainWithdrawalPage from '@/app/components/inventory/stockwithdrawal/LocMain/update';
  ...
  return (
    <div className="flex ml-15 mt-10">
      <div className="flex-grow md:ml-60 container mx-auto">
        <UpdateStockLocationMainWithdrawalPage params={params} />
      </div>
    </div>
  );
}
