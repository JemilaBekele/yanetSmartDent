...
const OrthoDataTable: React.FC = () => {
  ...
  const exportToExcel = () => {
    ...
    try {
      ...
      XLSX.utils.book_append_sheet(wb, ws, 'Orthodontics Patients');
      const fileName = `orthodontics_patients_${new Date().toISOString().split('T')[0]}.xlsx`;
  ...
  if (loading) return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="text-center">
        <Spinner />
        <p className="mt-4 text-slate-600 font-light">Loading orthodontics patients...</p>
      </div>
    </div>
  );
        ...
        <div className="bg-white shadow-sm border-b border-gray-200 p-4 fixed top-0 left-0 right-0 z-20">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-slate-800">Orthodontics</h1>
      ...
      <div className={`pt-${isMobile ? '20' : '4'} pb-6 px-3 sm:px-4 md:px-6 ${isMobile ? '' : 'md:ml-60'}`}>
          ...
          <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-4 sm:mb-6">
            <div className="flex flex-col gap-4">
              <div className="text-center sm:text-left">
                <h1 className="text-xl sm:text-2xl font-bold text-slate-800 mb-2">Orthodontics Patients</h1>
                <p className="text-sm sm:text-base text-slate-600">Manage orthodontics patients and their treatment records</p>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-3 sm:p-4 md:p-6 mb-4 sm:mb-6">
          <div className="flex flex-wrap gap-2 sm:gap-3 justify-center sm:justify-start">
            <Link href="/admin/Paradoni" className="inline-block">
          ...
          {filteredRows.length === 0 && (
            <div className="text-center py-6 sm:py-8">
              ...
              <p className="text-slate-600 mb-4 text-sm sm:text-base">
                {rows.length === 0 
                  ? "There are no orthodontics patients in the system." 
