    ...
    <div className="flex-grow md:ml-60 container mx-auto p-4">
      <div className="flex space-x-8">
        ...
        <div className="w-2/3 bg-white p-6 rounded-lg shadow-md">
          <h1 className="text-2xl font-bold mb-4">Edit Dental Findings</h1>
          <Image
            src="/assets/dentalreco.png"
            alt="Example Image"
            width={500}
            height={50}
            priority
        ...
        <div className="mt-4">
          ...
          >
            ...
            {formMessage && (
              <div className={`mt-4 p-2 rounded-md ${formMessage.includes("success") ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}>
                {formMessage}
              </div>
            )}
          </form>
