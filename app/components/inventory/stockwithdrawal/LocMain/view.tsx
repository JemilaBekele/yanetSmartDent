...
const StockLocationMainWithdrawalDetailPage: React.FC<StockWithdrawalViewProps> = ({ id }) => {
  ...
  const handleStatusUpdate = async () => {
    ...
    setUpdating(true);
    try {
      const response = await fetch(`/api/inventory/loctoMainstockwithdrawal/approve/${id}`, {
        method: 'PATCH',
        headers: {
...
export default StockLocationMainWithdrawalDetailPage;