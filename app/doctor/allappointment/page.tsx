...
const TodayAppointments: React.FC = () => {
  ...
  // Use all appointments for the logged-in doctor (no selection needed)
  const filteredAppointments = showPastAppointments ? sortedPastAppointments : sortedUpcomingAppointments;
  ...
  const calendarEvents: CalendarEvent[] = filteredAppointments.map((appt) => {
    ...
    return {
      ...
      extendedProps: {
        ...
        patientId: appt.patientId?.id?._id || ''
      },
    ...
    <div className="mt-24 ml-0 lg:ml-60 w-full max-w-6xl lg:max-w-[calc(100%-15rem)] mx-auto p-5 rounded-lg">
      ...
      {loading ? (
        ...
        <div className="w-full">
          {/* Main content - Appointments for current doctor */}
                      ...
                      {paginatedAppointments.length > 0 ? (
                        ...
                        <TableRow>
                          <TableCell colSpan={7} className="text-center text-gray-500">
                            No {showPastAppointments ? "past" : "upcoming"} appointments found.
                          </TableCell>
                        </TableRow>
                      )}
                    </TableBody>
